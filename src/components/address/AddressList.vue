<template>
    <div class="address-list-container">
        ...
        <Pagination :total="totalCount" :currentPage="currentPage" @onClick="onClick"></Pagination>
    </div>
</template>
...
export default {
    name: "AddressList",
    components: {
        AddressItem, Pagination
    }, computed: {
        totalCount() {
            if (this.addressData == null) return 0
            return this.addressData.totalCount
        }, dataList() {
            if (this.addressData == null) return null
