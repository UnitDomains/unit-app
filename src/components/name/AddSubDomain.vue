...
<template>
    <div id="ContentContainer">
        <div class="detail-base-info-container" v-if="!editAreaVisible">
            ...
            <UnitButton :caption="$t('singleName.subdomains.add')" @onClick="onShowEditAreaButtonClick" :enable="true"
        ...
        <div v-else class="detail-collapse-container">
            <div class="detail-base-info-container">
                <div class="detail-base-info">
                    ...
                    <input class="custom-input-box" :placeholder="$t('singleName.subdomains.add')"
                        @keyup.enter="onAddressContentChange" @input="onAddressContentChange" v-model="newContent" />
                </div>
            </div>
            ...
            <div class="detail-base-info-foot" style="padding:1em;">
                <UnitButton :caption="$t('c.cancel')" @onClick="onHideEditAreaButtonClick" :enable="true"
                    type="primary"></UnitButton>
                <UnitButton :caption="$t('singleName.subdomains.add')" @onClick="onOkButtonClick"
                    :enable="contentValidate" type="primary"></UnitButton>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    data() {
        return {
            editAreaVisible: false, newContent: ''
