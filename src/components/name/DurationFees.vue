<template>
    <div id="DurationContainer" class="register-duration-panel">
        <div class="register-duration-year-unit-panel">
            <div
                class="register-duration-year-unit-period"
            >{{ $t('pricer.registrationPeriodLabel') }}</div>

            <div class="register-duration-year-unit-price">{{ $t('pricer.registrationPriceLabel') }}</div>
        </div>
        <div class="register-duration-input-panel">
            <InputNumber :enabled="true" :value="years" @onChange="onDurationChange"></InputNumber>
