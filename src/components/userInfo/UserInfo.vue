...
<template>
    <div class="user-info-container" v-if="userAccountValidate">
        <div class="user-block" :style="{ backgroundImage: `url(${blockImgURL})` }" @click="onBlockClick"></div>
    ...
    <div v-else>
        <UnitButton :caption="$t('c.connect')" @onClick="onConnectClick" type="primary" :enable="true">
        </UnitButton>
