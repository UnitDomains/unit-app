...
import {
    labelhash
} from 'contracts/utils/labelhash.js'
import {
    calculateDuration
} from 'utils/dates.js'
...
async function getEthRegisterPrice(domainName, years) {
    ...
    var rentPrice = new EthVal((await registrar.getRentPrice(domainName, duration)))
    var regPrice = new EthVal((await registrar.getRegisterPrice(domainName, duration)))
